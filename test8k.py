...
audio_category = ['air_conditioner', 'car_horn', 'children_playing', 'dog_bark', 'drilling', 'engine_idling', 'gun_shot', 'jackhammer', 'siren', 'street_music']
...
best_model = keras.models.load_model('./8K_best_model/_i=4_0.8803418874740601_weight.h5')
